...
import { Heart, Share2, Star, Filter } from "lucide-react";

export const metadata: Metadata = {
  title: "Favorites - Doora",
  description: "View and manage your favorite items on Doora marketplace.",
};
          ...
          <Card className="text-center py-12">
            <CardContent>
              ...
              <p className="text-muted-foreground mb-4">
                Start browsing and heart items you love to see them here
              </p>
        ...
        {favoriteItems.length > 0 && (
          <div className="text-center mt-12">
            <p className="text-sm text-muted-foreground mb-4">
              Showing {favoriteItems.length} of {favoriteItems.length} favorites
            </p>
